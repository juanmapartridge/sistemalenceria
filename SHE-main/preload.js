...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    adjustClientBalance: (data) => ipcRenderer.invoke('db-adjust-client-balance', data),
    ...
    imprimirTicket: (html, deviceName) => ipcRenderer.invoke('print-ticket', html, deviceName),
    getMobileUrl: () => ipcRenderer.invoke('get-mobile-url'),
});